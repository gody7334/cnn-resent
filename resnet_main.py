...
# bazel-bin/resnet/resnet_main --train_data_path=../../ipython/cnn-cifar10/data/cifar-10-batches-bin/data_batch* --log_root=/tmp/resnet/log --train_dir=/tmp/resnet/train --dataset='cifar10' --num_gpus=1 &
# bazel-bin/resnet/resnet_main --eval_data_path=../../ipython/cnn-cifar10/data/cifar-10-batches-bin/test_batch.bin --log_root=/tmp/resnet/log --eval_dir=/tmp/resnet/test --mode=eval --dataset='cifar10' --num_gpus=1 &"""

# bazel-bin/resnet/resnet_main --train_data_path=../../ipython/cnn-cifar10/data/cifar-10-batches-bin/data_batch* --log_root=/tmp/resnet/log --train_dir=/tmp/resnet/train --dataset='cifar10' --num_gpus=1 &
# bazel-bin/resnet/resnet_main --eval_data_path=../../ipython/cnn-cifar10/data/cifar-10-batches-bin/test_batch.bin --log_root=/home/ipython/resnet/tb-log/resnet10/log --eval_dir=/home/ipython/resnet/tb-log/resnet10/test --mode=eval --dataset='cifar10' --num_gpus=1 &
